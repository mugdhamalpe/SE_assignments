...
void Book::set_details(){
    ...
    try{
        ...
        if (page_count<=0){
            ...
            cout<<"Entered page count found valid, you may continue..."<<endl;
        }
    }
        ...
        cout<<"Invalid title entered. Title length should be greater than 3"<<endl;
        this->title =" ";
        this->price = 0.0;
        this->page_count = 0;
    }
...
void Tape::set_details(){
    ...
    try{
        ...
        cout<<"Invalid title entered. Title length should be less than 3."<<endl;
        this->title =" ";
        this->price = 0.0;
        this->playing_time = 0.0;
    }
    ...
    try{
        ...
        if (playing_time<=0.0){
            ...
            cout<<"Entered playing time is found valid, you may continue..."<<endl;
        }
    }
...
void Tape::get_details(){
    ...
    cout<<"The playing time of the tape is "<<playing_time<<" minutes"<<endl;
}
